...
export default function CoursePage() {
  ...
  const courses = [
    {
      ...
      imageBg: 'from-amber-600/20 to-amber-950/20',
    },
    {
      id: 2,
      ...
      imageBg: 'from-blue-600/20 to-zinc-950/20',
    },
    {
      id: 3,
      ...
      imageBg: 'from-yellow-600/20 to-zinc-950/25',
    },
    {
      id: 4,
      ...
      imageBg: 'from-red-600/20 to-zinc-950/40',
    },
    {
      id: 5,
      ...
      imageBg: 'from-amber-700/20 to-zinc-950/30',
    },
    {
      id: 6,
      ...
      imageBg: 'from-emerald-600/20 to-zinc-950/30',
    },
    {
      id: 7,
      ...
      imageBg: 'from-amber-500/20 to-zinc-950/30',
    },
    {
      id: 8,
      ...
      imageBg: 'from-blue-500/20 to-zinc-950/30',
    },
    {
      id: 9,
      ...
      imageBg: 'from-purple-500/20 to-zinc-950/30',
    },
    {
      id: 10,
      ...
      imageBg: 'from-teal-500/20 to-zinc-950/30',
    },
    {
      id: 11,
      ...
      imageBg: 'from-indigo-500/20 to-zinc-950/30',
    },
    {
      id: 12,
      ...
      imageBg: 'from-cyan-500/20 to-zinc-950/30',
    },
    {
      id: 13,
      ...
      imageBg: 'from-yellow-500/20 to-zinc-950/30',
    },
    {
      id: 14,
      ...
      imageBg: 'from-pink-500/20 to-zinc-950/30',
    },
    {
      id: 15,
      ...
      imageBg: 'from-orange-500/20 to-zinc-950/30',
    },
    {
      id: 16,
      ...
      imageBg: 'from-emerald-500/20 to-zinc-950/30',
    },
    {
      id: 17,
      ...
      imageBg: 'from-purple-600/20 to-zinc-950/30',
    },
    {
      id: 18,
      ...
      imageBg: 'from-red-500/20 to-zinc-950/30',
    },
    {
      id: 19,
      ...
      imageBg: 'from-pink-600/20 to-zinc-950/30',
    },
    {
      id: 20,
      ...
      imageBg: 'from-yellow-600/20 to-zinc-950/30',
    },
    {
      id: 21,
      ...
      imageBg: 'from-teal-600/20 to-zinc-950/30',
    },
  ];
  ...
  const handleOpenEnroll = (course) => {
    ...
    if (course.durationPrices) {
      // Default to 8 Weeks option if available, otherwise first option
      setSelectedDuration(Object.keys(course.durationPrices).includes('8 Weeks') ? '8 Weeks' : Object.keys(course.durationPrices)[0]);
    } else {
  ...
  const handleInquirySubmit = async (e) => {
    ...
    const finalCourseTitle = selectedCourse.durationPrices
      ? `${selectedCourse.title} (${selectedDuration})`
      : selectedCourse.title;

    try {
      await startPayuPayment({
        courseId: selectedCourse.id,
        duration: selectedCourse.durationPrices ? selectedDuration : null,
    ...
    <main className="py-20 md:py-28 bg-zinc-950 text-zinc-100 min-h-screen relative">
      ...
      {showToast && (
        <div className="fixed bottom-5 right-5 z-50 max-w-md bg-zinc-900 border border-amber-500/30 text-white rounded-xl shadow-2xl p-4 flex gap-3 items-center animate-in fade-in slide-in-from-bottom-5 duration-300">
          ...
          <div>
            <p className="text-xs font-bold text-amber-400 uppercase tracking-widest">Payment Successful</p>
            <p className="text-xs text-zinc-300 mt-0.5">Enrollment confirmed. Our training mentor will contact you within 24 hours.</p>
          </div>
        </div>
      )}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mt-3 mb-6 leading-tight">
            Structured Industrial Trainings
          </h1>
          <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed uppercase tracking-wider font-semibold">
            Gain job-ready skills designed in collaboration with board guidelines to meet mandatory academic training requirements.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {courses.map((course) => (
            <div
              key={course.id}
              className="relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 p-6 sm:p-8 flex flex-col justify-between hover:border-zinc-800 transition-all duration-300 hover:shadow-2xl hover:shadow-amber-500/[0.01]"
            >
              <div className={`absolute inset-0 bg-gradient-to-br ${course.imageBg} opacity-20 pointer-events-none`}></div>
              
              <div className="relative">
                <div className="flex items-center justify-between gap-4 mb-5">
                  <span className="inline-flex items-center rounded-md bg-zinc-900 border border-zinc-800/80 px-2.5 py-1 text-[10px] font-bold uppercase tracking-wider text-zinc-300">
                    ⏱️ {course.duration}
                  </span>
                ...
                <h2 className="text-lg sm:text-xl font-bold text-white mb-3 hover:text-amber-400 transition-colors">
                  {course.title}
                </h2>
                ...
                <div className="mb-6 space-y-2.5">
                  <p className="text-[10px] font-bold text-zinc-300 tracking-widest uppercase">Course Syllabus:</p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {course.modules.map((mod, index) => (
                      <div key={index} className="flex gap-2 items-start p-2 rounded-lg bg-zinc-900/30 border border-zinc-900/50">
                        <span className="text-[9px] font-bold text-amber-500 bg-amber-500/10 h-5 w-5 rounded flex items-center justify-center shrink-0">
                          {index + 1}
                        </span>
                        <span className="text-[11px] text-zinc-400 leading-tight">{mod}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                {/* Features list */}
                <div className="mb-6">
                  <p className="text-[10px] font-bold text-zinc-300 tracking-widest uppercase mb-3">Key Inclusions:</p>
              ...
              <div className="relative border-t border-zinc-900 pt-5 flex items-center justify-between gap-4 mt-4">
                <div>
                  <span className="text-[9px] text-zinc-500 font-bold uppercase tracking-widest">Enrolment Fee</span>
                  <p className="text-xl font-black text-white">₹{course.price.toLocaleString()}</p>
                </div>
                <button
                  onClick={() => handleOpenEnroll(course)}
                  className="inline-flex items-center justify-center text-xs font-bold uppercase tracking-widest text-zinc-950 bg-amber-400 hover:bg-amber-300 rounded-lg px-5 py-3 shadow-md shadow-amber-500/5 transition-all"
                >
                  Enroll / Inquiry
                </button>
              </div>
      ...
      {selectedCourse && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-zinc-950/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative w-full max-w-md overflow-y-auto rounded-xl border border-zinc-900 bg-zinc-950 p-6 shadow-2xl space-y-5">
            {/* Close */}
            <button
            ...
            <div>
              <span className="text-[10px] font-bold text-amber-500 uppercase tracking-widest">Secure Enrollment</span>
              <h2 className="text-lg font-bold text-white mt-1">{selectedCourse.title}</h2>
              <p className="text-xs text-zinc-400 mt-1">
                Course fee: ₹{(selectedCourse.durationPrices ? selectedCourse.durationPrices[selectedDuration] : selectedCourse.price).toLocaleString()}
              </p>
            </div>

            <form onSubmit={handleInquirySubmit} className="space-y-4 pt-2">
              {selectedCourse.durationPrices && (
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-zinc-400 mb-1.5">Select Duration</label>
                  <select
                  ...
                  >
                    {Object.keys(selectedCourse.durationPrices).map((dur) => (
                      <option key={dur} value={dur}>
                        {dur} - ₹{selectedCourse.durationPrices[dur].toLocaleString()}
                      </option>
                    ))}
                  </select>
                </div>
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={submitting}
                  className="inline-flex items-center justify-center text-xs font-bold uppercase tracking-wider text-zinc-950 bg-amber-400 hover:bg-amber-300 disabled:bg-amber-400/50 rounded-lg px-6 py-2.5 transition-colors"
                >
                  {submitting ? 'Processing...' : `Pay ₹${(selectedCourse.durationPrices ? selectedCourse.durationPrices[selectedDuration] : selectedCourse.price).toLocaleString()}`}
                </button>
              </div>
            </form>
          </div>
