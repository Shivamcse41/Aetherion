...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-zinc-950 text-zinc-100 pb-20 relative">
      {/* Toast Notification */}
      {showToast && (
        <div className="fixed bottom-5 right-5 z-50 max-w-md bg-zinc-900 border border-amber-500/30 text-white rounded-xl shadow-2xl p-4 flex gap-3 items-center animate-in fade-in slide-in-from-bottom-5 duration-300">
          ...
          <div>
            <p className="text-xs font-bold text-amber-400 uppercase tracking-widest">Application Submitted</p>
            <p className="text-xs text-zinc-300 mt-0.5">{toastMessage}</p>
          </div>
        </div>
      )}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 md:pt-16 text-center">
        <div className="relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 py-12 px-6 sm:px-12 text-center">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-500/5 via-zinc-950 to-zinc-950 pointer-events-none"></div>
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:14px_24px] pointer-events-none"></div>

          <div className="relative">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-amber-400/20 bg-amber-400/5 text-[10px] font-bold uppercase tracking-widest text-amber-400 mb-6 backdrop-blur-sm">
              ✨ Premium Industrial Projects & Allocations
            </div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight text-white mb-6 leading-tight max-w-4xl mx-auto">
              Find Your Dream{' '}
              <span className="bg-gradient-to-r from-amber-400 via-amber-200 to-amber-500 bg-clip-text text-transparent">
                Technical Internship
              </span>
            </h1>
            <p className="text-xs sm:text-sm text-zinc-400 max-w-2xl mx-auto leading-relaxed font-medium uppercase tracking-wider">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-12">
        <div className="relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 p-8 sm:p-12">
          ...
          <div className="relative grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl font-extrabold text-white mt-2 mb-4 leading-tight">
            ...
            <div className="hidden lg:block relative p-6 border border-zinc-900 rounded-xl bg-zinc-900/10 backdrop-blur-sm space-y-4">
              <div className="flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-emerald-500"></div>
                <span className="text-xs font-bold text-zinc-300">AICTE & DTE Compliant Logbooks</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-emerald-500"></div>
                <span className="text-xs font-bold text-zinc-300">Industry Expert Mentor Allocations</span>
              </div>
              <div className="flex items-center gap-3">
                <div className="h-2 w-2 rounded-full bg-emerald-500"></div>
                <span className="text-xs font-bold text-zinc-300">Verified Signature & Certificate of Work</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="listings" className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="rounded-xl border border-zinc-900 bg-zinc-950/60 p-5 space-y-6 sticky top-24">
            <div className="flex items-center justify-between border-b border-zinc-900 pb-3">
              <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-200">Refine Search</h3>
              <button
                onClick={() => {
            ...
            <div className="space-y-2">
              <label className="block text-[10px] font-bold uppercase tracking-widest text-zinc-400">Category</label>
              <select
            ...
            {/* Duration */}
            <div className="space-y-2">
              <label className="block text-[10px] font-bold uppercase tracking-widest text-zinc-400">Duration</label>
              <select
        ...
        <div className="lg:col-span-9 space-y-6">
          <div className="flex items-center justify-between border-b border-zinc-900 pb-3">
            <p className="text-xs font-semibold text-zinc-400">
              Showing <span className="text-amber-400 font-bold">{filteredInternships.length}</span> internships matching your criteria
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredInternships.length > 0 ? (
              filteredInternships.map((intern) => (
                <div
                  key={intern.id}
                  className="group relative rounded-xl border border-zinc-900 bg-zinc-950/60 p-5 flex flex-col justify-between hover:border-zinc-800/80 hover:bg-zinc-900/10 transition-all duration-300 shadow-lg hover:shadow-2xl hover:shadow-amber-500/[0.01]"
                >
                  <div>
                    <div className="flex items-start justify-between gap-3 mb-3">
                      ...
                      {intern.featured && (
                        <span className="inline-flex items-center gap-1 rounded bg-amber-400/10 border border-amber-400/25 px-2 py-0.5 text-[9px] font-black uppercase text-amber-400">
                          ⭐ Hot Role
                        </span>
                      )}
                    </div>
                    ...
                    <div className="flex flex-wrap gap-x-4 gap-y-1.5 text-[11px] text-zinc-400 mb-4">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-5">
                      {intern.skills.map((skill) => (
                        <span
                          key={skill}
                          className="rounded-md bg-zinc-900 px-2 py-1 text-[9px] font-bold text-zinc-300 border border-zinc-800/60"
                        >
                          {skill}
                        </span>
                      ))}
                    ...
                    <button
                      ...
                      className="w-full inline-flex items-center justify-center text-xs font-bold uppercase tracking-wider text-zinc-300 border border-zinc-800 hover:border-amber-500/30 hover:bg-amber-500/5 hover:text-amber-400 rounded-lg py-2.5 transition-all"
                    >
                      View details & Apply
                    </button>
                  </div>
              ...
              <div className="col-span-full py-16 text-center border border-zinc-900/60 rounded-xl bg-zinc-950/60">
                <p className="text-sm font-semibold text-zinc-300 mb-1 uppercase tracking-wider">No internship listings found</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-24">
        <div className="relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 py-16 px-6 sm:px-12 text-center">
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-amber-500/5 via-zinc-950 to-zinc-950 pointer-events-none"></div>
          ...
          <div className="relative">
            {/* Quick Search */}
            <div className="max-w-2xl mx-auto p-2.5 rounded-xl border border-zinc-800 bg-zinc-900/60 backdrop-blur-md flex flex-col sm:flex-row gap-2 shadow-2xl">
              <div className="flex-1 relative">
                <input
                  ...
                  className="w-full bg-transparent pl-9 pr-4 py-2.5 text-xs text-white placeholder-zinc-500 focus:outline-none"
                />
                <svg className="absolute left-3 top-3 h-4 w-4 text-zinc-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
              </div>
              <a
                href="#listings"
                className="inline-flex items-center justify-center text-xs font-bold uppercase tracking-widest text-zinc-950 bg-amber-400 hover:bg-amber-300 rounded-lg px-6 py-3 transition-colors shrink-0"
              >
                Search
              </a>
            </div>
            ...
            {/* Trust Badges */}
            <div className="mt-8 flex flex-wrap justify-center items-center gap-x-8 gap-y-3 text-[10px] font-bold uppercase tracking-widest text-zinc-500">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <div className="relative overflow-hidden rounded-2xl border border-zinc-900 bg-zinc-950 p-8 sm:p-12">
          ...
          <div className="absolute top-0 right-0 w-72 h-72 bg-amber-500/5 rounded-full blur-[100px] pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 w-56 h-56 bg-amber-700/5 rounded-full blur-[80px] pointer-events-none"></div>
          ...
          <div className="relative">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-10">
              <div>
                ...
                <p className="text-zinc-400 text-xs sm:text-sm leading-relaxed mt-2 max-w-xl">
              ...
              <a
                href="/services"
                className="shrink-0 inline-flex items-center justify-center gap-2 text-xs font-bold uppercase tracking-widest text-zinc-950 bg-amber-400 hover:bg-amber-300 rounded-lg px-7 py-3.5 shadow-lg shadow-amber-500/10 transition-all hover:-translate-y-0.5 active:translate-y-0"
              >
                View Services
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                <div
                  key={tile.label}
                  className="flex items-start gap-4 rounded-xl border border-zinc-900 bg-zinc-900/20 p-5 hover:border-zinc-800 hover:bg-zinc-900/40 transition-all"
                >
                  <div className="h-9 w-9 shrink-0 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-400 flex items-center justify-center">
                    {tile.icon}
                  </div>
                  <div>
                    <p className="text-xs font-black text-white uppercase tracking-wide">{tile.label}</p>
                    <p className="text-[11px] text-zinc-500 mt-1 leading-snug">{tile.desc}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      {selectedInternship && (
        <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-zinc-950/80 backdrop-blur-sm animate-in fade-in duration-200">
          <div className="relative w-full max-w-2xl max-h-[85vh] overflow-y-auto rounded-xl border border-zinc-900 bg-zinc-950 p-6 sm:p-8 shadow-2xl space-y-6">
            {/* Close */}
            <button
            ...
            {/* Header info */}
            <div>
              <span className="text-[10px] font-bold text-amber-500 uppercase tracking-widest">{selectedInternship.company}</span>
              <h2 className="text-xl sm:text-2xl font-bold text-white mt-1">{selectedInternship.title}</h2>
            ...
            {/* Content info */}
            <div className="space-y-4 border-t border-zinc-900 pt-4 text-xs sm:text-sm text-zinc-300 leading-relaxed">
              <div>
                <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-1.5">Role Description</h4>
                <p>{selectedInternship.description}</p>
              </div>
              <div>
                <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-1.5">Basic Requirements</h4>
                <p>{selectedInternship.requirements}</p>
              </div>
              <div>
                <h4 className="text-xs font-bold text-white uppercase tracking-widest mb-1.5">Perks & Allowances</h4>
                <p>{selectedInternship.perks}</p>
              </div>
            </div>

            {/* Apply Form */}
            <form onSubmit={handleApplySubmit} className="border-t border-zinc-900 pt-6 space-y-4">
              <h3 className="text-xs font-bold uppercase tracking-widest text-zinc-200">Application Form</h3>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-zinc-400 mb-1.5">College Name</label>
                  <input
                    type="text"
                    required
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase tracking-widest text-zinc-400 mb-1.5">Year of Study</label>
                  <select
              ...
              <div className="flex justify-end gap-3 pt-2">
                <button
                  type="button"
                  onClick={handleCloseApply}
                  className="inline-flex items-center justify-center text-xs font-bold uppercase tracking-wider text-zinc-400 border border-zinc-900 hover:bg-zinc-900 rounded-lg px-5 py-2.5 transition-colors"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="inline-flex items-center justify-center text-xs font-bold uppercase tracking-wider text-zinc-950 bg-amber-400 hover:bg-amber-300 rounded-lg px-6 py-2.5 transition-colors"
                >
                  Submit Application
                </button>
              </div>
